export const profile = {
  ...
  shortName: 'Loan Ladiff',
  title: 'Software Engineer',
  focus: 'Frontend Specialist, Backend in Progress',
  location: 'Monrovia, Liberia',
  tagline:
    'I build calm, fast interfaces and the systems behind them. Frontend is my home base; backend is the territory I am actively learning to own.',
  bio: [
...
export const skillGroups = [
  ...
  {
    title: 'Backend',
    weight: 'Currently Learning',
    items: [
      { name: 'Node.js', level: 70 },
      { name: 'Express', level: 64 },
      { name: 'PostgreSQL', level: 60 },
      { name: 'Supabase', level: 72 },
      { name: 'REST APIs', level: 70 },
      { name: 'Authentication & Sessions', level: 58 },
    ],
  },
  {
    title: 'Tooling & Craft',
    ...
    items: [
      ...
      { name: 'Administrative Coordination', level: 78 },
    ],
  },
];
