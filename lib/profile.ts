export const profile = {
  name: 'Loan Ladiff Sedo-Ta',
  role: 'Software engineer',
  location: 'Monrovia, Liberia',
  timeZone: 'Africa/Monrovia',
  headline:
    'I build mobile and web apps that hold up on slow networks, in Monrovia and beyond.',
  intro:
    'Software engineer from Cameroon, based in Liberia. The frontend is my home base. Lately most of my hours go into the other half: Supabase schemas, NestJS services and realtime game servers.',
  bio: [
...
export const skillGroups = [
  {
    ...
    items: ['React', 'Next.js', 'TypeScript', 'React Native and Expo', 'Tailwind CSS', 'Angular'],
  },
  {
    title: 'What I’m growing into',
    items: ['Supabase and PostgreSQL', 'Node.js, Express and NestJS', 'Realtime with Colyseus and Socket.io', 'Python and Django', 'FastAPI'],
  },
  {
